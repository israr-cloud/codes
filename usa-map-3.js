document.addEventListener("DOMContentLoaded", function() {
    ...
    let htmlContent = ` 
      ...
      <div class="arrow-down-mark">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink"
          width="487"
          zoomAndPan="magnify"
          viewBox="0 0 365.25 316.499999"
          height="422"
          preserveAspectRatio="xMidYMid meet"
          version="1.0"
        >
          <defs>
            <clipPath id="a44fa18a97">
              <path
                d="M 4.535156 4.585938 L 360 4.585938 L 360 312.953125 L 4.535156 312.953125 Z M 4.535156 4.585938 "
                clip-rule="nonzero"
              />
            </clipPath>
          </defs>
          <g clip-path="url(#a44fa18a97)">
            <path
              fill="var(--white-smoke)"
              d="M 7.804688 32.050781 L 7.804688 32.054688 L 169.488281 304.089844 L 169.570312 304.09375 C 172.617188 309.363281 178.25 312.953125 184.773438 312.953125 C 190.625 312.953125 195.773438 310.070312 198.976562 305.683594 L 199.023438 305.683594 L 199.128906 305.5 C 199.722656 304.664062 200.226562 303.765625 200.667969 302.832031 L 356.792969 31.9375 L 356.789062 31.933594 C 358.664062 29.132812 359.765625 25.769531 359.765625 22.144531 C 359.765625 12.410156 351.871094 4.519531 342.136719 4.519531 L 22.375 4.519531 C 12.640625 4.519531 4.753906 12.410156 4.753906 22.144531 C 4.753906 25.820312 5.882812 29.226562 7.804688 32.050781 Z M 7.804688 32.050781 "
              fill-opacity="1"
              fill-rule="nonzero"
            />
          </g>
      ...
      <div class="statesInfo">
        <div class="Alabama">
          <h3>Efficient Construction Equipment Management in Alabama</h3>
          <p>
            ...
            resource oversight, enhancing operational efficiency. With a focus
            on real-time data, Clue helps streamline operations, minimize
            delays, and support informed decision-making, ensuring that
            contractors can effectively manage their projects.
          </p>
        </div>
        <div class="Alaska">
          <h3>Track and Manage Equipment in Alaska with Clue</h3>
          <p>
            With Clue’s solutions, Alaska contractors can maintain operational
            efficiency while addressing the unique demands of the state’s
            diverse landscapes. Key features include equipment management and
            maintenance, real-time dispatch management, project coordination
            tools, and data analytics. These capabilities enable teams to work
            efficiently, even in remote locations, and help contractors make
            informed decisions to improve project timelines and reduce costs.
          </p>
        </div>
        <div class="Arizona">
          <h3>Optimize Construction Projects with Clue in Arizona</h3>
          <p>
            Clue offers Arizona businesses a comprehensive suite that integrates
            equipment management, maintenance tracking, and compliance
            monitoring to drive construction efficiency. Our platform provides
            full visibility over equipment, enabling you to streamline
            workflows, minimize downtime, and optimize operations with real-time
            data and intuitive tools.
          </p>
        </div>
        <div class="Arkansas">
          <h3>We provide construction equipment software in Arkansas</h3>
          <p>
            Clue is now serving Arkansas and surrounding areas! Our intuitive
            software provides a single pane of glass, helping contractors
            improve workflow efficiency and make data-driven decisions that
            drive cost savings. Key features like real-time equipment tracking
            and automated maintenance scheduling give you the control needed to
            keep your projects on track. Stay competitive in Arkansas’s
            fast-paced construction industry with Clue’s insights. Let us help
            elevate your operations today!
          </p>
        </div>
        <div class="California">
          <h3>
            Revitalize Your Construction Operations with Clue in California
          </h3>
          <p>
            Clue provides advanced, multifaceted solutions for maintenance
            oversight, fleet tracking, and compliance in the construction
            industry. Our platform is designed to adapt to California's
            fast-paced, diverse construction landscape.
            <br /><br />With features like real-time equipment tracking,
            optimized resource allocation, and automated maintenance alerts,
            Clue helps reduce downtime and improve operational efficiency.
          </p>
        </div>
        <div class="Colorado">
          <h3>Streamline Construction Operations with Clue in Colorado</h3>
          <p>
            Clue offers a comprehensive solution for maintenance oversight,
            fleet tracking, and compliance in construction across Colorado. Our
            platform provides real-time control over equipment, allowing you to
            monitor usage, reduce downtime, and optimize resource allocation.
            <br /><br />With features like a unified dashboard, dispatch
            management, fuel tracking, and telematics integration, Clue ensures
            seamless operations. It helps contractors streamline tasks, improve
            maintenance scheduling, and boost efficiency from start to finish.
          </p>
        </div>
        <div class="Connecticut">
          <h3>Optimize Construction Operations with Clue in Connecticut</h3>
          <p>
            Clue supports construction operations through integrated fleet
            management, maintenance tracking, compliance, and operational
            analytics tailored for Connecticut contractors. The platform offers
            real-time monitoring of equipment performance, enabling effective
            tracking of machinery and resource allocation to prevent costly
            downtime. With automated routine maintenance features, Clue reduces
            unexpected delays and helps extend the lifespan of your equipment,
            ensuring smoother project execution.
          </p>
        </div>
        <div class="Delaware">
          <h3>
            Improve Workflow With construction equipment software in Delaware
          </h3>
          <p>
            ...
            monitoring, and safety. Key features include advanced resource
            allocation tools and comprehensive equipment usage tracking, which
            help minimize delays and improve overall project efficiency. This
            allows teams to collaborate effectively and share insights to
            enhance project coordination.
          </p>
        </div>
        <div class="Florida">
          <h3>Optimize Construction Projects with Clue in Florida</h3>
          <p>
            ...
            Key functionalities include real-time equipment tracking, automated
            maintenance scheduling, fuel management, and detailed reporting.
            These features improve collaboration among teams, allowing them to
            adapt quickly to changes and maintain project schedules efficiently.
            Clue focuses on operational efficiency to ensure better outcomes for
            every construction project.
          </p>
        </div>
        <div class="Georgia">
          <h3>Construction equipment Management with Clue in Georgia</h3>
          <p>
            For Georgia, Clue unites fleet management, maintenance tracking,
            compliance monitoring, and safety protocols for construction
            industry excellence. The platform streamlines construction
            management, providing features designed to improve resource
            oversight. Key capabilities include real-time data analytics,
            effective resource management, and collaborative tools that allow
            teams to work efficiently and adapt to project needs.
          </p>
        </div>
        <div class="Hawaii">
          <h3>
            Manage Constructions Operations with Equipment Software in Hawaii
          </h3>
          <p>
            Clue is a complete solution for fleet management, maintenance
            tracking, compliance monitoring, and operational analytics. Key
            features include real-time data analytics, resource optimization
            tools, and enhanced collaboration capabilities. These features
            enable teams to streamline workflows effectively, ensuring efficient
            project execution and better adaptability to the unique demands of
            the Hawaiian construction landscape.
          </p>
        </div>
        <div class="Idaho">
          <h3>Leading Construction Equipment Software in Idaho</h3>
          <p>
            Clue offers a comprehensive platform for managing fleet performance,
            tracking maintenance, and ensuring compliance in the construction
            industry in Idaho. Our software helps contractors optimize
            maintenance processes, minimize downtime, and keep machinery ready
            for the job.
            <br /><br />With real-time monitoring, automated maintenance
            scheduling, and detailed asset tracking, Clue provides the insights
            needed to enhance equipment efficiency and improve overall project
            execution.
          </p>
        </div>
        <div class="Illinois">
          <h3>
            Manage Construction Equipment Effectively with Clue in Illinois
          </h3>
          <p>
            Clue is a comprehensive solution that combines management software
            with maintenance tracking and compliance monitoring to streamline
            construction workflows in Illinois. Our platform allows for precise
            equipment tracking and maintenance, helping you prevent issues
            before they escalate and ensuring smooth project execution.
            <br /><br />With features like real-time monitoring and automated
            maintenance alerts, Clue empowers you to optimize equipment usage
            and maintain efficiency throughout the project lifecycle.
          </p>
        </div>
        <div class="Indiana">
          <h3>Enhance Resource Planning with Clue in Indiana</h3>
          <p>
            Contractors throughout Indiana can now access efficient features for
            fleet management, maintenance scheduling, compliance monitoring, and
            safety. Designed to tackle specific local market challenges, our
            software streamlines operations and enhances communication among
            teams. Key features include real-time tracking, resource management,
            and automated maintenance, ensuring efficient project execution and
            improved collaboration.
          </p>
        </div>
        <div class="Iowa">
          <h3>Efficient Equipment Management Software in Iowa</h3>
          <p>
            We offer Iowa contractors an integrated solution for equipment
            maintenance, fleet management, and compliance tracking. Our platform
            enhances equipment tracking and resource management, empowering
            businesses to make data-driven decisions.
            <br /><br />With the unified dashboard feature, contractors gain
            comprehensive visibility, making it easier to monitor equipment
            performance, optimize resource allocation, and minimize downtime.
          </p>
        </div>
        <div class="Kansas">
          <h3>We provide construction equipment software in Kansas</h3>
          <p>
            At Clue, we proudly serve Kansas contractors with a comprehensive
            solution that integrates maintenance tracking, fleet oversight, and
            operational analytics. Whether working on large infrastructure or
            smaller projects, our platform tracks equipment usage, optimizes
            resource allocation, and minimizes downtime.
            <br /><br />With features like utilization reports, automated work
            orders, preventive maintenance scheduling, dispatch management, and
            fuel tracking, Clue streamlines operations and enhances overall
            efficiency.
          </p>
        </div>
        <div class="Kentucky">
          <h3>Transform Equipment Management with Clue in Kentucky</h3>
          <p>
            Clue provides a unified solution that enhances fleet management,
            tracks maintenance, ensures compliance, and manages safety for
            contractors in Kentucky. The platform simplifies tracking of
            equipment and resources to ensure optimal efficiency on every
            project. Key features include real-time data analytics, automated
            maintenance scheduling, utilization tracking, and resource
            management tools. These capabilities enhance decision-making and
            help contractors maintain control over timelines and budgets,
            ultimately improving project outcomes.
          </p>
        </div>
        <div class="Louisiana">
          <h3>Optimize Construction Equipment Use with Clue in Louisiana</h3>
          <p>
            Clue integrates fleet management, maintenance tracking, and safety
            compliance into one solution for contractors in Louisiana. The
            platform provides real-time monitoring of equipment usage,
            optimizing resource allocation and reducing downtime. By utilizing
            Clue’s tools, contractors can ensure their machinery operates at
            peak performance, enhancing overall productivity.
          </p>
        </div>
        <div class="Maine">
          <h3>Optimize Equipment Management in Maine with Clue</h3>
          <p>
            In Maine, contractors need flexible and reliable solutions to keep
            their equipment in optimal condition for various construction
            projects. Clue is an all-in-one software that promotes seamless
            collaboration among teams, enhancing project coordination. Key
            maintenance features include automated maintenance scheduling,
            real-time tracking of maintenance tasks, and alerts for upcoming
            service needs. By leveraging data analytics, contractors gain
            actionable insights that enhance efficiency and reduce costs.
          </p>
        </div>
        <div class="Maryland">
          <h3>
...
<br><br>Discover how Clue can improve your construction processes today.
        ...
        <div class="Massachusetts">
          <h3>Construction Fleet Management Software in Massachusetts</h3>
          <p>
            ...
            provide valuable insights, Massachusetts contractors can optimize
            their operations and boost productivity.
          </p>
        </div>
        <div class="Michigan">
          <h3>Ensure Project Success with Clue in Michigan</h3>
          <p>
            Clue equips Michigan contractors with a streamlined construction
            equipment management solution tailored for fleet oversight,
            maintenance tracking, compliance activities, and safety protocols
            throughout the state. Designed to accommodate both urban and rural
            demands, our platform ensures flexibility and responsiveness. With
            features like real-time tracking, resource management, and automated
            maintenance, Clue helps businesses adapt to changing project
            requirements, enhancing operational efficiency in a competitive
            environment.
          </p>
        </div>
        <div class="Minnesota">
          <h3>Boost Construction Project Efficiency with Clue in Minnesota</h3>
          <p>
            Clue proudly serves Minnesota contractors with an all-in-one
            platform that integrates equipment management, maintenance tracking,
            and compliance to drive construction project success.
            <br /><br />By providing real-time data, Clue offers clearer
            insights into equipment usage, helping reduce costs and eliminate
            inefficiencies. Features like automated work orders streamline
            maintenance processes, ensuring equipment remains in optimal
            condition. This proactive approach enhances project management and
            boosts overall productivity.
          </p>
        </div>
        <div class="Mississippi">
          <h3>Construction Equipment Software for Mississippi Projects</h3>
          <p>
            Across Mississippi, Clue offers an integrated platform for managing
            fleets, scheduling maintenance, tracking compliance, and ensuring
            safety. With advanced features like predictive maintenance alerts
            and real-time usage tracking, Clue allows you to proactively address
            potential issues before they escalate. By choosing Clue, you not
            only improve workflows but also ensure every decision is
            data-driven, enhancing overall project efficiency.
          </p>
        </div>
        <div class="Missouri">
          <h3>Construction Equipment Software Solution in Missouri</h3>
          <p>
            At Clue, we’re dedicated to providing Missouri contractors with
            comprehensive solutions that enhance construction operations through
            fleet management, maintenance tracking, and compliance. Our platform
            lets you monitor and manage equipment in real time, optimize
            resource allocation, and reduce downtime, ensuring project
            efficiency.
            <br /><br />With features like automated maintenance reminders and
            utilization reports, Clue helps streamline operations and boost
            productivity. Ready to elevate your project management with Clue?
          </p>
        </div>
        <div class="Montana">
          <h3>Comprehensive Construction Equipment Management in Montana</h3>
          <p>
            Clue offers a robust construction equipment management platform
            designed to streamline operations and optimize project outcomes. Our
            suite of tools goes beyond basic management, incorporating real-time
            fleet tracking, preventative maintenance schedules, and safety
            compliance features. These capabilities help contractors in
            Montana—and beyond—reduce inefficiencies, cut costs, and maintain
            control over their resources, regardless of project size.
            <br /><br />By simplifying equipment tracking and automating
            maintenance, Clue empowers contractors to minimize downtime,
            optimize workflows, and ensure every asset contributes to project
            success. Whether you're managing large-scale developments or smaller
            projects, Clue provides the tools you need to enhance productivity
            and drive construction efficiency.
          </p>
        </div>
        <div class="Nebraska">
          <h3>
...
<br><br>See how Clue transforms construction operations in Nebraska today.
        ...
        <div class="Nevada">
          <h3>Track and Manage Equipment in Nevada with Clue</h3>
          <p>
            Clue is a comprehensive solution that combines equipment management,
            maintenance tracking, and fleet oversight for the construction
            sector in Nevada. Our platform enables efficient resource
            management, tracks equipment usage, and minimizes downtime, whether
            on large urban projects or remote construction sites.
            <br /><br />With real-time equipment monitoring, automated
            maintenance scheduling, and telematics integration, Clue ensures
            optimal performance and keeps projects running smoothly.
          </p>
        </div>
        <div class="New-Hampshire">
          <h3>Best construction equipment software in New Hampshire</h3>
          <p>
            Clue provides New Hampshire contractors with a single pane of glass
            with features such as real-time resource management, automated
            maintenance scheduling, and performance analytics. These tools
            streamline workflows and enhance communication among teams, allowing
            contractors to adapt quickly to changing conditions and optimize
            their operations effectively. This ensures improved productivity and
            reduced downtime on construction projects.
          </p>
        </div>
...
<br><br>Experience the benefits of Clue in New Jersey’s dynamic construction landscape today.
        ...
        <div class="New-Mexico">
          <h3>Construction Equipment Software for New Mexico</h3>
          <p>
            Clue offers New Mexico businesses an efficient solution that
            combines maintenance tracking, fleet management, and compliance
            oversight. Designed to meet the diverse needs of the state’s
            construction industry, our platform streamlines operations, reduces
            inefficiencies, and improves resource planning.
            <br /><br />With Clue, you can track equipment performance and make
            smarter, data-driven decisions to enhance overall project
            management.
          </p>
        </div>
        <div class="New-York">
          <h3>
            Optimize Construction Equipment Usage with Software in New York
          </h3>
          <p>
            In New York, contractors can utilize Clue's robust platform that
            integrates fleet management, maintenance oversight, compliance
            activities, and safety management. The platform is designed to
            enhance efficiency and collaboration on complex projects, addressing
            the diverse needs of the construction landscape. Key features
            include real-time equipment monitoring, automated maintenance
            alerts, and performance analytics. By streamlining operations, Clue
            helps ensure that contractors can adapt to varying demands
            effectively.
          </p>
        </div>
...
<br><br>Discover how Clue supports smarter construction management in New Brunswick today.
        ...
        <div class="North-Carolina">
          <h3>
            Track and Manage Equipment in Real-Time with Clue in North Carolina
          </h3>
          <p>
        ...
        <div class="North-Dakota">
          <h3>Track and Optimize Equipment in North Dakota with Clue</h3>
          <p>
            In North Dakota, Clue provides integrated solutions designed to
            centralize equipment management, streamline fleet operations, and
            ensure compliance monitoring for the construction sector. Our
            platform offers robust tools for tracking equipment, optimizing
            resource allocation, and improving maintenance schedules, keeping
            machinery in peak condition while minimizing downtime.
            <br /><br />Clue's real-time tracking, automated maintenance
            features, and centralized data integration empower contractors to
            enhance operational efficiency and maintain comprehensive control
            over equipment performance. By uniting these critical processes,
            Clue ensures seamless project execution and better decision-making
            at every stage.
          </p>
        </div>
        <div class="Ohio">
          <h3>Simplify Equipment Management with Clue in Ohio</h3>
          <p>
            ...
            maintenance scheduling, utilization tracking, and resource
            management tools. These capabilities enable contractors to adapt
            quickly to project changes, enhance operational efficiency, and
            drive success in Ohio’s competitive market.
          </p>
        </div>
        <div class="Oklahoma">
          <h3>Track & Manage Equipments in Real-Time with Clue in Oklahoma</h3>
          <p>
            Clue integrates fleet oversight, maintenance tracking, and
            compliance management into a holistic solution for construction
            operations in Oklahoma. Our platform efficiently tracks assets,
            reduces downtime, and optimizes resource allocation, making it
            easier to manage projects of all sizes.
            <br /><br />With enhanced workflows and data-driven insights, Clue
            helps you boost productivity, minimize costs, and ensure successful
            project execution.
          </p>
        </div>
        <div class="Oregon">
          <h3>Construction Equipment Software in Oregon</h3>
          <p>
            Clue is a holistic construction equipment management solution
            designed to streamline operations for businesses in Oregon. By
            integrating maintenance tracking, operational analytics, and fleet
            management, our platform boosts productivity through efficient
            equipment management and resource optimization.
            <br /><br />Whether working on urban infrastructure or rural
            projects, Clue ensures that your equipment remains in optimal
            condition. With real-time fleet tracking, automated maintenance
            scheduling, and asset monitoring, Clue minimizes downtime and
            enhances project efficiency across all phases.
          </p>
        </div>
        <div class="Pennsylvania">
          <h3>
            Enhance Project Planning with Equipment Software in Pennsylvania
          </h3>
          <p>
            Clue is dedicated to helping Pennsylvania contractors streamline
            operations with comprehensive solutions for managing fleets,
            tracking maintenance, ensuring compliance, and enhancing safety. Our
            platform enhances efficiency by integrating project oversight with
            tailored resource management to tackle unique challenges. Key
            features include real-time data analytics, automated maintenance
            scheduling, and resource tracking, enabling contractors to quickly
            respond to project changes and optimize performance.
          </p>
        </div>
...
<br><br>Explore the benefits of Clue for construction projects in Prince Edward Island today.
        ...
        <div class="Rhode-Island">
          <h3>
            Construction Fleet Management Software Solutions in Rhode Island
          </h3>
          <p>
            Clue is an all-in-one platform helping contractors in Rhode Island
            with fleet management, maintenance tracking, operational compliance,
            and project analytics. These solutions allow teams to effectively
            manage, maintain and track equipment including their availability
            and usage, ensuring that resources are deployed optimally. By
            leveraging real-time data, contractors can make informed decisions
            to improve efficiency and drive project success.
          </p>
        </div>
        <div class="South-Carolina">
          <h3>
            Boost Equipment Efficiency with Construction Software in South
            Carolina
          </h3>
          <p>
            Clue is a comprehensive tool that enhances fleet management,
            maintenance tracking, compliance oversight, and safety in
            construction to contractors in South Carolina. Key features include
            real-time data analytics, streamlined workflows, resource management
            tools, and collaboration features. These tools enhance project
            efficiency and adaptability in diverse construction environments,
            enabling teams to respond effectively to challenges.
          </p>
        </div>
        <div class="South-Dakota">
          <h3>Construction Equipment Software for South Dakota</h3>
          <p>
            As a contractor in South Dakota, you understand the challenges of
            managing equipment and projects efficiently—every delay costs time
            and money. Clue offers a comprehensive solution to enhance
            maintenance tracking, operational compliance, and fleet management.
            Whether you're working on small residential builds or large
            infrastructure projects, our platform is designed to minimize
            downtime and keep your operations running smoothly.
          </p>
        </div>
        <div class="Tennessee">
          <h3>Boost Equipment Operational Efficiency with Clue in Tennessee</h3>
          <p>
            Clue is dedicated to empowering Tennessee contractors by integrating
            fleet management, maintenance tracking, safety compliance, and
            operational insights for construction excellence. Our innovative
            platform enhances construction management by enabling efficient
            equipment and resource management. With features like real-time data
            analytics, automated maintenance scheduling, utilization tracking,
            and streamlined workflows, Clue helps contractors make informed
            decisions and boost productivity for effective project execution.
          </p>
        </div>
        <div class="Texas">
          <h3>
            Efficient Construction Equipment Management with Clue in Texas
          </h3>
          <p>
            For businesses across Texas, Clue offers an integrated platform for
            equipment maintenance, fleet management, and operational compliance.
            Our platform provides a powerful, fully customizable approach to
            managing construction equipment, tailored to the scale and diversity
            of Texas projects.
            <br /><br />With tools for resource allocation and performance
            monitoring, Clue enables you to optimize operations and make
            data-driven decisions that improve overall project efficiency.
          </p>
        </div>
        <div class="Utah">
          <h3>
            Optimize Construction with Equipment Management Software in Utah
          </h3>
          <p>
            Clue is committed to helping contractors across Utah with a robust
            platform that integrates fleet management, maintenance tracking, and
            compliance monitoring. More than just standard management software,
            our platform simplifies equipment management for both large
            infrastructure projects and smaller developments.
            <br /><br />Clue enables efficient equipment tracking, resource
            allocation, and downtime reduction, ensuring that projects stay on
            schedule and within budget.
          </p>
        </div>
        <div class="Vermont">
          <h3>Track & Manage Equipment Use with Clue in Vermont</h3>
          <p>
            Clue offers Vermont contractors a robust platform with features like
            maintenance tracking, fleet management, safety compliance, and
            operational analytics for improved performance. These features
            enhance communication and collaboration among teams, allowing them
            to navigate the unique challenges of Vermont's diverse construction
            environments more effectively.
          </p>
        </div>
        <div class="Virginia">
          <h3>Real-Time Equipment Management with Clue in Virginia</h3>
          <p>
            ...
            Designed to optimize resource use and enhance project efficiency,
            tailored for the diverse construction landscape, the platform
            supports everything from urban developments to rural projects. Key
            features focus on real-time collaboration, enabling teams to respond
            swiftly to changing conditions and improve overall operational
            effectiveness.
          </p>
        </div>
        <div class="Washington">
          <h3>Construction Equipment Software Solutions in Washington</h3>
          <p>
            Clue is an intuitive construction equipment software designed
            specifically for the construction industry. It offers a
            comprehensive solution by integrating fleet management, maintenance
            tracking, and compliance monitoring into a single, user-friendly
            platform. In Washington, Clue provides contractors with the tools
            they need to streamline equipment operations, enhance productivity,
            and maintain control over their projects. Its advanced features,
            including real-time fleet tracking, automated maintenance schedules,
            and asset monitoring, help businesses reduce downtime, optimize
            resource allocation, and boost project efficiency. By centralizing
            data and simplifying equipment management, Clue empowers contractors
            to make informed decisions at every project phase. Whether managing
            large-scale developments or smaller tasks, Clue ensures your
            operations run smoothly, saving time and reducing costs.
            <br /><br />Explore how Clue can transform your construction
            operations today.
          </p>
        </div>
        <div class="West-Virginia">
          <h3>Track and Optimize Construction Equipment in West Virginia</h3>
          <p>
            Clue provides a comprehensive approach to construction management,
            integrating fleet tracking, maintenance oversight, compliance, and
            safety throughout West Virginia. Key features include real-time
            equipment tracking, resource allocation tools, improved site
            communication, and automated maintenance scheduling. These tools are
            designed for both small and large-scale projects, allowing
            contractors to adapt quickly to changing conditions and enhance
            overall project efficiency.
          </p>
        </div>
        <div class="Wisconsin">
          <h3>Track and Optimize Construction Equipment in Wisconsin</h3>
          <p>
            Clue is dedicated to providing Wisconsin contractors with tailored
            construction equipment management solutions to meet their unique
            project needs. Our construction equipment maintenance software
            allows real-time management and maintenance, helping reduce downtime
            and optimize resource allocation.
            <br /><br />With features like automated maintenance alerts and
            utilization tracking, Clue ensures you stay competitive in the
            dynamic construction landscape.
          </p>
        </div>
        <div class="Wyoming">
          <h3>Boost Efficiency with Equipment Software in Wyoming</h3>
          <p>
            Clue integrates fleet management, maintenance tracking, and
            compliance oversight into a single platform for contractors in
            Wyoming. Our solution streamlines equipment tracking, optimizes
            resource allocation, and ensures efficient maintenance processes,
            helping businesses stay on top of project timelines.
            <br /><br />With real-time fleet monitoring, automated maintenance
            scheduling, and data-driven resource management, Clue minimizes
            downtime, enhances productivity, and provides contractors with
